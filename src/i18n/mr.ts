...
export const i18n = {
  ariaLinkLabel: 'Medianova.com भेट द्या',
  enterCode: 'कोड टाकाा',
  ...
  footer:
    'द्वारे संरक्षित <a href="https://www.medianova.com/" target="_blank" aria-label="Medianova.com भेट द्या">Medianova</a>',
...
globalThis.altchaI18n.set('mr', i18n);
